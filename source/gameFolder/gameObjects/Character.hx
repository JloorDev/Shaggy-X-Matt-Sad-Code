	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'matt':
				...
				addOffset('idle');
				addOffset("singUP", -52, 20);
				addOffset("singRIGHT", -5, -21);
				addOffset("singLEFT", 32, -36);
				addOffset("singDOWN", -73, -28);
				addOffset("singUPmiss", -52, 20);
				addOffset("singRIGHTmiss", -5, -21);
				addOffset("singLEFTmiss", 32, -36);
				addOffset("singDOWNmiss", -73, -28);
			...
			case 'bf-matt-lost':
				frames = Paths.getSparrowAtlas('characters/matt_lost');
			...
			case 'shaggy':
				...
				animation.addByPrefix('singRIGHT', 'shaggy_left', 20);
				animation.addByPrefix('singDOWN', 'shaggy_down', 24);
				animation.addByPrefix('singLEFT', 'shaggy_right', 24);

				addOffset('idle');
				addOffset("singUP", -19, 24);
				addOffset("singRIGHT", 148, -36);
				addOffset("singLEFT", -58, -120);
				addOffset("singDOWN", 97, -169);
